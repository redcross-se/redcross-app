...
const styles = StyleSheet.create({
  container: {
    ...
    height: 70, // Adjusted height for a slightly larger navigation bar
    marginBottom: 20, // Elevated from the bottom of the screen
    flexDirection: 'row',
  ...
  iconImage: {
    width: 24, // Match icon size to design
    height: 24,
    resizeMode: 'contain', // Ensure image scales correctly
  },
  indicator: {
    width: 20, // Match width to the indicator in the design
    height: 2,
